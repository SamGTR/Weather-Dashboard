// JS file when search history clicked
...
// Function executed when search history clicked
$('.buttonAppend').on('click','.cityButtonEl', function(event){
    var cityName = $(event.target).attr('value');
    cityEl.value = "";
